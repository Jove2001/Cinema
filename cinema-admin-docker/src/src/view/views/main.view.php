...
Cinema Admin application

main.view.php 10/05/2023
...
<head>
    ...
    <!-- Set icon-->
    <link rel="icon" href="/media/CinemaAdmin.png" type="image/x-icon" />
...
<body>
    <nav class="navbar navbar-expand-md bg-body-tertiary nav-pills">
        <div class="container-fluid">
            <a class="navbar-brand" href="/"><img src="/media/CinemaAdmin.png" alt="logo" style="width:40px;" class="rounded-pill"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="/index.php">Session Admin</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/index.php?page=movies">Browse Movies</a>
                    </li>
                    <li class="nav-item">
    ...
    <section>
        <div class='container-fluid row-gap-3'>
            <?php if (isset($route->View)) require_once $route->View; ?>
        </div>
    </section>
